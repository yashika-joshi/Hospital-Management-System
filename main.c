...
// Macros for formatting and screen clearing
#define CENTER_SPACES "                                            "
#define MAX_CAPACITY 5  // Maximum allowed patients
...
int main() {
    ...
    while (1) {
        ...
        switch (choice) {
            case 1:
                if (countPatients(patientQueue) >= MAX_CAPACITY) {
                    printf(CENTER_SPACES "No patients can be added. Maximum capacity of %d reached.\n", MAX_CAPACITY);
                    break;
                }
